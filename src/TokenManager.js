            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, axios_1["default"].post(this.monitoring_url_auth, querystring.stringify({ email: config_1["default"].monitoringApiConfig.email, password: config_1["default"].monitoringApiConfig.password }))];
                    case 1:
                        response = _a.sent();
